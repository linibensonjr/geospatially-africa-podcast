...
urlpatterns = [
    ...
    path('episode/<slug>/publish/', views.episode_publish, name='episode_publish'),
    path('episode/<slug:slug>/edit/', views.episode_edit, name='episode_edit'),
    path('episode/<slug:slug>/delete/', views.episode_delete, name='episode_delete'),
